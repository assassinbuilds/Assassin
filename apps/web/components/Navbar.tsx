            ...
            <div className="flex h-full flex-col">
              ...
              {isSignedIn ? (
                <div className="flex flex-col gap-3 border-t border-slate-100 pt-5 text-sm">
                   <Link href="/profile" className="font-bold uppercase tracking-widest text-slate-700" onClick={() => setMobileOpen(false)}>My Assassin</Link>
                   <Link href="/edit-profile" className="font-bold uppercase tracking-widest text-slate-700" onClick={() => setMobileOpen(false)}>Edit Profile</Link>
                   <Link href="/missions" className="font-bold uppercase tracking-widest text-slate-700" onClick={() => setMobileOpen(false)}>My Missions</Link>
                   <Link href="/profile" className="font-bold uppercase tracking-widest text-slate-700" onClick={() => setMobileOpen(false)}>Dashboard</Link>
