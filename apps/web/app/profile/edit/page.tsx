...
const profileSchema = z.object({
  ...
  graduation_year: z.any().optional(),
...
export default function EditProfile() {
  ...
  useEffect(() => {
    ...
    fetchProfile();
  }, [isLoaded, userId, user, clerkFullName, router, reset, setValue]);
  ...
  const IMGBB_API_KEY = process.env.NEXT_PUBLIC_IMGBB_API_KEY || process.env.VITE_IMGBB_API_KEY || "";
