  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[#F8FAFC]">
        <Navbar dark={false} />
        <main className="max-w-7xl mx-auto px-6 pt-32 pb-20 flex justify-center items-center min-h-[50vh]">
      ...
      <Card className="border-none shadow-sm rounded-[2.5rem] bg-white overflow-hidden group-hover:shadow-xl transition-all duration-500 h-full">
        ...
        <CardContent className="p-8 pt-0 space-y-4">
          ...
          <div className="pt-4 flex items-center justify-between border-t border-slate-50">
             ...
             {event.prizes && !!event.prizes['1st'] && (
                <div className="flex items-center gap-2 text-red-600">
                   <Trophy className="w-4 h-4" />
                   <span className="text-xs font-black uppercase tracking-widest italic">{String(event.prizes['1st'])} Reward</span>
                </div>
             )}
          </div>
        </CardContent>
